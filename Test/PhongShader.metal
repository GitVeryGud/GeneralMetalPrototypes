...
half4 fragment fragmentPhong(v2f in [[stage_in]],  
    ...
    out_Color.rgb *= half3(
    uniforms.u_AmbientLightColor + //ambient color
    uniforms.u_LightColor * intensity + //directional light color
                           uniforms.u_LightColor * specular * uniforms.u_SpecularIntensity); //specular reflection
